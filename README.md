...
git clone https://github.com/fkbg750-web/teammind.git
cd teammind
...
# 方法2: 从本地项目创建新仓库
# 在 GitHub 创建新仓库后：
git remote add origin https://github.com/kbg750-web/AI-.git
git push -u origin master
```
...
```bash
# 克隆项目
git clone https://github.com/kbg750-web/teammind.git
cd teammind
